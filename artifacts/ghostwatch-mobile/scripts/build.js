...
// Use the port assigned by the artifact system (injected as $PORT).
// This avoids colliding with the Component Preview Server that owns 8081.
const METRO_PORT = parseInt(process.env.PORT || '8083', 10);
